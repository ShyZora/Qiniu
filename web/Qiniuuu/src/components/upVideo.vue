...
export default {
    ...
    methods: {
        uploadVideo() {
            ...
            var observable = qiniu.upload(file, key, 'ud1jGtOB-1fw0phJXYSgjjXE3hQ8xIYM0dhFOJXy:RGd6R6_B0xTgb_TmlOcWYF_lNhA=:eyJzY29wZSI6ImdvZ29nby1vZmZlciIsImRlYWRsaW5lIjoxNjk4OTMxOTQ4fQ==', config);  // _this.qiniuToken 由后端提供，通过接口获取
            var observer = {
                next(res) {    // 用于展示上传进度
